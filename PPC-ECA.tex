...
%Primeiro semestre
\includepdf[pages=-,nup=2x1, frame]{CAT410} % CAT001
...
\includepdf[pages=-,nup=2x1, frame]{CAT411} % CAT002
\includepdf[pages=-,nup=2x1, frame]{QUI075} % QUIXXB
\includepdf[pages=-,nup=2x1, frame]{QUI022} % QUIXAB
...
\includepdf[pages=-,nup=2x1, frame]{MEC124} %MECXX1
\includepdf[pages=-,nup=2x1, frame]{CAT176}
\includepdf[pages=-,nup=2x1, frame]{MTM146}
\includepdf[pages=-,nup=2x1, frame]{BCC704} % BCCXX3


% quinto semestre
\includepdf[pages=-,nup=2x1, frame]{BCC425}
\includepdf[pages=-,nup=2x1, frame]{EST202}
\includepdf[pages=-,nup=2x1, frame]{CAT412} % XXX003
\includepdf[pages=-,nup=2x1, frame]{CAT413} % XXX004
\includepdf[pages=-,nup=2x1, frame]{CAT414} % XXX029


%sexto semestre
\includepdf[pages=-,nup=2x1, frame]{CAT163}
\includepdf[pages=-,nup=2x1, frame]{CAT415} % XXX005
\includepdf[pages=-,nup=2x1, frame]{CAT416} % XXX006
\includepdf[pages=-,nup=2x1, frame]{CAT417} % XXX007
\includepdf[pages=-,nup=2x1, frame]{CAT418} % XXX008


%setimo semestre
\includepdf[pages=-,nup=2x1, frame]{CIV049} %Resistência dos Materiais para Controle e Automação CIVXXX
\includepdf[pages=-,nup=2x1, frame]{CAT419} %ELEMENTOS DE ROBÓTICA
\includepdf[pages=-,nup=2x1, frame]{CAT420} %Informática industrial ANTIGA CAT175
\includepdf[pages=-,nup=2x1, frame]{CAT421} %TEORIA DE CONTROLE III
\includepdf[pages=-,nup=2x1, frame]{BCC740} %INTELIGENCIA ARTIFICIAL
\includepdf[pages=-,nup=2x1, frame]{CAT422} %sistema integrado de manufatura XXX023

%Oitavo semestre
\includepdf[pages=-,nup=2x1, frame]{CAT423} % XXX013
\includepdf[pages=-,nup=2x1, frame]{MEC142} %
\includepdf[pages=-,nup=2x1, frame]{CAT424} % XXX014
\includepdf[pages=-,nup=2x1, frame]{BCC722}


%Nono semestre
\includepdf[pages=-,nup=2x1, frame]{CAT425} % XXX015 (TFC1)
...
% eletivas
\includepdf[pages=-,nup=2x1, frame]{CAT426} %XXX016
\includepdf[pages=-,nup=2x1, frame]{CAT427} %XXX017
\includepdf[pages=-,nup=2x1, frame]{CAT428} %XXX018
\includepdf[pages=-,nup=2x1, frame]{CAT429} %XXX019
\includepdf[pages=-,nup=2x1, frame]{CAT430} %XXX020
\includepdf[pages=-,nup=2x1, frame]{CAT431} %XXX021
\includepdf[pages=-,nup=2x1, frame]{CAT432} %XXX022
\includepdf[pages=-,nup=2x1, frame]{CAT433} %CAT342
\includepdf[pages=-,nup=2x1, frame]{CAT334}
\includepdf[pages=-,nup=2x1, frame]{CAT341}
\includepdf[pages=-,nup=2x1, frame]{CAT434} %XXX024
\includepdf[pages=-,nup=2x1, frame]{CAT601}
\includepdf[pages=-,nup=2x1, frame]{CAT435} % XXX030
...
\includepdf[pages=-,nup=2x1, frame]{CAT436} %XXX031
