...
5 &
  ...
  Doutor &
  Engenharia Elétrica &
  \begin{tabular}[c]{@{}l@{}} História da Ciência e da Engenharia Elétrica \\ Métodos Matemáticos de Engenharia \\ \end{tabular} \\
12 &
...
\begin{table}[ht]
	...
	\resizebox{0.9\textwidth}{!}{%
		\begin{tabular}{@{}lcc@{}}
			...
			Disciplinas Obrigatórias                & 52          & 2790          \\
...
%% TRECHO REMOVIDO A PEDIDO DOS DOCENTES
%\item \textbf{XXX008 - Laboratório de Controle I:} Como a disciplina deve constar com um módulo relacionado à simulação digital via GNU Octave, Scilab ou Matlab, as práticas extensionistas se concentração no oferecimento de um minicurso de programação para o software adotado na disciplina CAT 141 (Teoria de Controle) no formato online.
%
%\item \textbf{CAT 012 - Sistemas Integrados de Manufatura:} Os discentes farão um projeto que envolva oo diversos conceitos estudados durante a graduação, todo o desenvolvimento do projeto será registrado por meio de fotos, vídeo e ilustrações, gerando um relatório. Todo material produzido, tanto na forma de vídeo quanto na forma de texto, será disponibilizado de forma pública para a comunidade por meio de apostilas (ou livros) digitais de acesso livre e aberto, redes sociais, plataformas de vídeo, ou também por meio de exposições (virtuais ou presenciais, a depender dos recursos disponíveis) para escolas do ensino médio de Ouro Preto e Região.
%
\end{itemize}
...
%As AACCE podem ser constituídas, dentre outras, de atividades de monitoria, Pró-Ativa, pesquisa, extensão, visitas técnicas, participação em eventos acadêmicos, cursos de curta ou longa diração, bem como estágios extracurriculares que ultrapassam as horas de estágio obrigatório.\footcite[Ver Resolução CONEC N$^\circ$ 19, de 15 de março de 2022, em: ][]{CONEC-UFOP-19-2022}
...
\begin{comment}
Seguem, em breves palavras, alguns relatos de professores que utilizaram tais recursos no ensino superior:

\epigraph{``...~Os discentes trabalharam em pequenos grupos para editar um artigo da Wikipédia relacionado ao material do curso e que ainda não havia sido descrito adequadamente.''}{Anne J. McNeil, profa. de Química, Universidade de Michigam, EUA. Nível do curso: doutorado.}

\epigraph{``...~Os discentes escolheram um assunto para o semestre, pesquisaram-no, contribuíram
em um verbete da Wikipédia e então escreveram um trabalho de pesquisa sobre o mesmo assunto.''}{Rochelle Davis, profa. de Antropologia, Universidade de Georgetown, EUA.}

\epigraph{``...~Durante as primeiras 4 semanas, pedi aos meus discentes que escrevessem um relatório de 3 páginas no qual analisassem o estado atual dos artigos escolhidos para revisão futura, com uma leitura crítica tanto do conteúdo como da forma.''}{Juliana Bastos Marques, Profa. da Universidade Federal do Estado do Rio de Janeiro (UNIRIO), Brasil. Nível do curso: graduação.}

\epigraph{``...~Em cada um desses cursos, os discentes foram convidados a trabalhar em grupos para criar ou melhorar artigos da Wikipédia relacionados ao tema do curso.''}{Jon Beasley-Murray, Professor associado da Universidade da Colúmbia Britânica, Canadá. Nível do curso: graduação avançada.}

\epigraph{``...~Pedi aos meus discentes que visitassem a Wikipédia e encontrassem um artigo que pudesse usar uma explicação para representar graficamente o que estava
escrito em palavras.''}{Bruce Sharky, Prof. da Universidade do Estado da Louisiana, EUA. Nível do curso: mestrado.}
\end{comment}
...
%Primeiro semestre
\includepdf[pages=-,nup=2x1, frame]{CAT001}
\includepdf[pages=-,nup=2x1, frame]{BCC703}
\includepdf[pages=-,nup=2x1, frame]{MTM122}
\includepdf[pages=-,nup=2x1, frame]{MTM730}
\includepdf[pages=-,nup=2x1, frame]{ARQ700}
...
%Segundo semestre
\includepdf[pages=-,nup=2x1, frame]{BCC704}
\includepdf[pages=-,nup=2x1, frame]{FIS106}
\includepdf[pages=-,nup=2x1, frame]{FIS107}
\includepdf[pages=-,nup=2x1, frame]{MTM123}
\includepdf[pages=-,nup=2x1, frame]{CAT002}
\includepdf[pages=-,nup=2x1, frame]{QUIXXB}
\includepdf[pages=-,nup=2x1, frame]{QUIXAB}


% terceiro semestre
\includepdf[pages=-,nup=2x1, frame]{BCC721}
\includepdf[pages=-,nup=2x1, frame]{BCC760}
\includepdf[pages=-,nup=2x1, frame]{FIS108}
\includepdf[pages=-,nup=2x1, frame]{MTM124}
\includepdf[pages=-,nup=2x1, frame]{MTM125}
\includepdf[pages=-,nup=2x1, frame]{AMB111}


% quarto semestre
\includepdf[pages=-,nup=2x1, frame]{FIS109}
\includepdf[pages=-,nup=2x1, frame]{FIS105}
\includepdf[pages=-,nup=2x1, frame]{MECXX1}
\includepdf[pages=-,nup=2x1, frame]{CAT176}
\includepdf[pages=-,nup=2x1, frame]{MTM146}
\includepdf[pages=-,nup=2x1, frame]{BCCXX3}


% quinto semestre
\includepdf[pages=-,nup=2x1, frame]{BCC425}
\includepdf[pages=-,nup=2x1, frame]{EST202}
\includepdf[pages=-,nup=2x1, frame]{XXX003}
\includepdf[pages=-,nup=2x1, frame]{XXX004}
\includepdf[pages=-,nup=2x1, frame]{XXX029}


%sexto semestre
\includepdf[pages=-,nup=2x1, frame]{CAT163}
\includepdf[pages=-,nup=2x1, frame]{XXX005}
\includepdf[pages=-,nup=2x1, frame]{XXX006}
\includepdf[pages=-,nup=2x1, frame]{XXX007}
\includepdf[pages=-,nup=2x1, frame]{XXX008}


%setimo semestre
\includepdf[pages=-,nup=2x1, frame]{CIVXXX} %Resistência dos Materiais para Controle e Automação
\includepdf[pages=-,nup=2x1, frame]{XXX009} %ELEMENTOS DE ROBÓTICA
\includepdf[pages=-,nup=2x1, frame]{CAT175} %Informática industrial
\includepdf[pages=-,nup=2x1, frame]{XXX008} %TEORIA DE CONTROLE III
\includepdf[pages=-,nup=2x1, frame]{BCC740} %INTELIGENCIA ARTIFICIAL
\includepdf[pages=-,nup=2x1, frame]{XXX023} %sistema integrado de manufatura

%Oitavo semestre
\includepdf[pages=-,nup=2x1, frame]{XXX013}
\includepdf[pages=-,nup=2x1, frame]{MEC142}
\includepdf[pages=-,nup=2x1, frame]{XXX014}
\includepdf[pages=-,nup=2x1, frame]{BCC722}


%Nono semestre
\includepdf[pages=-,nup=2x1, frame]{XXX015}
\includepdf[pages=-,nup=2x1, frame]{DIR250}
\includepdf[pages=-,nup=2x1, frame]{PRO224}
\includepdf[pages=-,nup=2x1, frame]{MIN107}
\includepdf[pages=-,nup=2x1, frame]{MET702}


%Decimo semestre
\includepdf[pages=-,nup=2x1, frame]{CAT491}
\includepdf[pages=-,nup=2x1, frame]{PRO243}
\includepdf[pages=-,nup=2x1, frame]{PRO215}

% eletivas
\includepdf[pages=-,nup=2x1, frame]{XXX016}
\includepdf[pages=-,nup=2x1, frame]{XXX017}
\includepdf[pages=-,nup=2x1, frame]{XXX018}
\includepdf[pages=-,nup=2x1, frame]{XXX019}
\includepdf[pages=-,nup=2x1, frame]{XXX020}
\includepdf[pages=-,nup=2x1, frame]{XXX021}
\includepdf[pages=-,nup=2x1, frame]{XXX022}
\includepdf[pages=-,nup=2x1, frame]{CAT342}
\includepdf[pages=-,nup=2x1, frame]{CAT334}
\includepdf[pages=-,nup=2x1, frame]{CAT341}
\includepdf[pages=-,nup=2x1, frame]{XXX024}
\includepdf[pages=-,nup=2x1, frame]{CAT601}
\includepdf[pages=-,nup=2x1, frame]{XXX030}
\includepdf[pages=-,nup=2x1, frame]{BCC408}
\includepdf[pages=-,nup=2x1, frame]{BCC406}
\includepdf[pages=-,nup=2x1, frame]{BCC264}
\includepdf[pages=-,nup=2x1, frame]{BCC321}
\includepdf[pages=-,nup=2x1, frame]{BCC326}
\includepdf[pages=-,nup=2x1, frame]{BCC362}
\includepdf[pages=-,nup=2x1, frame]{BCC503}
\includepdf[pages=-,nup=2x1, frame]{BCC221}
\includepdf[pages=-,nup=2x1, frame]{BCC263}
\includepdf[pages=-,nup=2x1, frame]{CSO010}
\includepdf[pages=-,nup=2x1, frame]{FIL652}
\includepdf[pages=-,nup=2x1, frame]{LET041}
\includepdf[pages=-,nup=2x1, frame]{MEC104}
\includepdf[pages=-,nup=2x1, frame]{MEC108}
\includepdf[pages=-,nup=2x1, frame]{PRO302}
\includepdf[pages=-,nup=2x1, frame]{PRO706}
\includepdf[pages=-,nup=2x1, frame]{XXX031}
\includepdf[pages=-,nup=2x1, frame]{PRO725}
\chapter{Resoluções CECAU}
